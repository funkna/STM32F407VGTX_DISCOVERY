...
//! \ref docs\stm32f407_reference_manual.pdf section 6.
//------------------------------------------------------------------------------
#ifndef __RCC_H
#define __RCC_H
...
//------------------------------------------------------------------------------
//! \brief RCC Controller Register Bitmasks
//------------------------------------------------------------------------------
...
#define CFGR_PPRE2_OFFSET     (13)
#define CFGR_PPRE2            (0x07UL << CFGR_PPRE2_OFFSET)
#define CFGR_PPRE1_OFFSET     (10)
#define CFGR_PPRE1            (0x07UL << CFGR_PPRE1_OFFSET)
#define CFGR_HPRE_OFFSET      (4)
#define CFGR_HPRE             (0x0FUL << CFGR_HPRE_OFFSET)
#define CFGR_SWS_OFFSET       (2)
#define CFGR_SWS              (0x03UL << CFGR_SWS_OFFSET)
...
//------------------------------------------------------------------------------
//! \brief Reset & Clock Control Controller Register Structure
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
void RCC_Initialize();
BOOL RCC_EnablePeripheralClock(STM32F407VGT6_PeriperalEnum ePeripheral_);
BOOL RCC_ResetPeripheralClock(STM32F407VGT6_PeriperalEnum ePeripheral_);
ClockSourceEnum RCC_GetSystemClockSource();
UINT RCC_GetClockFrequency(ClockTypeEnum eClockType_);
